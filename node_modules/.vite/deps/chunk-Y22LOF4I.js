...
} from "./chunk-FRJ62I2K.js";
import {
  warnOnce
} from "./chunk-TTGKUZR6.js";
import {
  major
} from "./chunk-PTUN6X4Z.js";
import {
  DialogContent_default
} from "./chunk-JJ5NNBFC.js";
import {
  Dialog_default,
  dialogClasses_default
} from "./chunk-TYFUM6LY.js";
import {
  DialogActions_default
} from "./chunk-YGGZIKEK.js";
import {
  Chip_default,
  InputAdornment_default
} from "./chunk-XMVZBVWL.js";
import {
  TextField_default
} from "./chunk-SQEBKUCI.js";
import {
  InputLabel_default
} from "./chunk-Q3GNSKZN.js";
import {
  FormHelperText_default
} from "./chunk-VDSFGABD.js";
import {
  FormControl_default
} from "./chunk-V6UPWHTQ.js";
import {
  useFormControl
} from "./chunk-Q5XTY2ON.js";
import {
  Popper_default
} from "./chunk-IASITW2X.js";
import {
  Button_default
} from "./chunk-ZJCNVTIN.js";
import {
  useMediaQuery_default
} from "./chunk-MHRDGP2O.js";
import {
  ListItem_default
} from "./chunk-SJHAWVQM.js";
import {
  Typography_default
} from "./chunk-KCDTNACC.js";
import {
  useThemeProps
} from "./chunk-ZYZ5457T.js";
import {
  Grow_default
} from "./chunk-T4GT6PPY.js";
import {
  IconButton_default
} from "./chunk-324OP52O.js";
import {
  ButtonBase_default
} from "./chunk-BB3XCQ55.js";
import {
  Fade_default,
  FocusTrap_default
} from "./chunk-U77QVBGY.js";
import {
  Paper_default
} from "./chunk-UTPDMHRV.js";
import {
  CSSTransition_default,
  TransitionGroup_default
} from "./chunk-I6OSOS3D.js";
import {
  _objectWithoutPropertiesLoose
} from "./chunk-BFL632LT.js";
import {
  List_default
} from "./chunk-BGPGZ7CZ.js";
import {
  createSvgIcon
} from "./chunk-2E2PWWC6.js";
import {
  useTheme
} from "./chunk-JXQZ57G5.js";
import {
  alpha,
  shouldForwardProp,
  styled_default2 as styled_default,
  useRtl
} from "./chunk-5JTWULZB.js";
import {
  clsx_default
} from "./chunk-WYDCSZ6Y.js";
import {
  require_prop_types
} from "./chunk-IJSIPKXL.js";
import {
  _extends
...
var useFieldState = (parameters) => {
  ...
  const localizedDigits = React34.useMemo(() => getLocalizedDigits(adapter), [adapter]);
  const sectionsValueBoundaries = React34.useMemo(() => getSectionsBoundaries(adapter, localizedDigits, timezone), [adapter, localizedDigits, timezone]);
  const getSectionsFromValue = React34.useCallback((valueToAnalyze) => fieldValueManager.getSectionsFromValue(valueToAnalyze, (date) => buildSectionsFromFormat({
    adapter,
    localeText: translations,
    localizedDigits,
    format,
  ...
  const parsedSelectedSections = React34.useMemo(() => parseSelectedSections(selectedSections, state.sections), [selectedSections, state.sections]);
  ...
  const areAllSectionsEmpty = React34.useMemo(() => state.sections.every((section) => section.value === ""), [state.sections]);
  const hasPartiallyFilledSectionsOnBlur = React34.useMemo(() => {
  ...
  const sectionToUpdateOnNextInvalidDateRef = React34.useRef(null);
...
function useFieldInternalPropsWithDefaults(parameters) {
  ...
  const handleChangeFromPicker = React35.useCallback((newValue, ctx) => {
    return setValue == null ? void 0 : setValue(newValue, {
      validationError: ctx.validationError,
      shouldClose: false
    });
  }, [setValue]);
  const internalPropsWithDefaultsFromContext = React35.useMemo(() => {
...
function useFieldHiddenInputProps(parameters) {
  ...
  const valueStr = React36.useMemo(() => areAllSectionsEmpty ? "" : fieldValueManager.getV7HiddenInputValueFromSections(state.sections), [areAllSectionsEmpty, state.sections, fieldValueManager]);
  return {
    value: valueStr,
...
function useFieldSectionContainerProps(parameters) {
  ...
  const createHandleClick = React37.useCallback((sectionIndex) => (event) => {
    if (disabled || event.isDefaultPrevented()) {
      return;
    }
    setSelectedSections(sectionIndex);
  }, [disabled, setSelectedSections]);
  return React37.useCallback((sectionIndex) => ({
...
function useFieldSectionContentProps(parameters) {
  ...
  const createFocusHandler = React38.useCallback((sectionIndex) => () => {
    if (disabled) {
      return;
    }
    setSelectedSections(sectionIndex);
  }, [disabled, setSelectedSections]);
  return React38.useCallback((section, sectionIndex) => {
    const sectionBoundaries = sectionsValueBoundaries[section.type]({
...
var useFieldV7TextField = (parameters) => {
  ...
  const sectionListRef = React39.useRef(null);
  const handleSectionListRef = useForkRef(sectionListRefProp, sectionListRef);
  const domGetters = React39.useMemo(() => ({
...
var useFieldV6TextField = (parameters) => {
  ...
  const openPickerAriaLabel = useOpenPickerButtonAriaLabel3(value);
  const sections = React40.useMemo(() => addPositionPropertiesToSections(state.sections, localizedDigits, isRtl), [state.sections, localizedDigits, isRtl]);
  ...
  const placeholder = React40.useMemo(() => {
    if (inPlaceholder !== void 0) {
      return inPlaceholder;
    }
    return fieldValueManager.getV6InputValueFromSections(getSectionsFromValue(valueManager.emptyValue), localizedDigits, isRtl);
  }, [inPlaceholder, fieldValueManager, getSectionsFromValue, valueManager.emptyValue, localizedDigits, isRtl]);
  const valueStr = React40.useMemo(() => state.tempValueStrAndroid ?? fieldValueManager.getV6InputValueFromSections(state.sections, localizedDigits, isRtl), [state.sections, fieldValueManager, state.tempValueStrAndroid, localizedDigits, isRtl]);
  React40.useEffect(() => {
  ...
  const inputMode = React40.useMemo(() => {
    if (activeSectionIndex == null) {
      return "text";
    }
  ...
  React40.useImperativeHandle(unstableFieldRef, () => ({
    getSections: () => state.sections,
...
function useApplyDefaultValuesToTimeFieldInternalProps(internalProps) {
  ...
  const ampm = React41.useMemo(() => internalProps.ampm ?? adapter.is12HourCycleInCurrentLocale(), [internalProps.ampm, adapter]);
  return React41.useMemo(() => _extends({}, internalProps, validationProps, {
...
var ClockIcon = createSvgIcon((0, import_jsx_runtime11.jsxs)(React44.Fragment, {
...
var TimeIcon = createSvgIcon((0, import_jsx_runtime11.jsxs)(React44.Fragment, {
  children: [(0, import_jsx_runtime11.jsx)("path", {
    d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"
  }), (0, import_jsx_runtime11.jsx)("path", {
    d: "M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"
...
function PickersSection(props) {
  ...
  const sectionContentRef = React45.useRef(null);
...
var PickersSectionList = React45.forwardRef(function PickersSectionList2(inProps, ref) {
  ...
  return (0, import_jsx_runtime12.jsx)(Root, _extends({}, rootProps, {
    children: rootProps.contentEditable ? elements.map(({
      ...
      before,
      after
    }) => `${before.children}${content.children}${after.children}`).join("") : (0, import_jsx_runtime12.jsx)(React45.Fragment, {
...
var PickersOutlinedInput = React49.forwardRef(function PickersOutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime15.jsx)(PickersInputBase, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime15.jsx)(Outline, {
      ...
      label: label != null && label !== "" && (muiFormControl == null ? void 0 : muiFormControl.required) ? (0, import_jsx_runtime15.jsxs)(React49.Fragment, {
        children: [label, " ", "*"]
      }) : label
    })
  }, other, {
...
var DateField = React54.forwardRef(function DateField2(inProps, inRef) {
  const themeProps = useThemeProps({
    props: inProps,
    name: "MuiDateField"
  });
...
var useCalendarState = (params) => {
  ...
  const adapter = usePickerAdapter();
  const reducerFn = React56.useRef(createCalendarStateReducer(Boolean(reduceAnimations), adapter)).current;
...
function PickersSlideTransition(inProps) {
  ...
  return (0, import_jsx_runtime23.jsx)(PickersSlideTransitionRoot, {
    className: clsx_default(classes.root, className),
    childFactory: (element) => React60.cloneElement(element, {
...
function WrappedDay(_ref) {
  ...
  const isOutsideCurrentMonth = React61.useMemo(() => adapter.getMonth(day) !== currentMonthNumber, [adapter, day, currentMonthNumber]);
  const ownerState = usePickerDayOwnerState({
    day,
    selected: isSelected,
    disabled: isDisabled,
...
function DayCalendar(inProps) {
  ...
  const validSelectedDays = React61.useMemo(() => selectedDays.filter((day) => !!day).map((day) => adapter.startOfDay(day)), [adapter, selectedDays]);
...
var MonthCalendarButton = React62.memo(function MonthCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
...
var MonthCalendar = React63.forwardRef(function MonthCalendar2(inProps, ref) {
  ...
  const todayMonth = React63.useMemo(() => adapter.getMonth(now), [adapter, now]);
  ...
  const [focusedMonth, setFocusedMonth] = React63.useState(() => selectedMonth || adapter.getMonth(referenceDate));
...
var YearCalendarButton = React64.memo(function YearCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
...
var YearCalendar = React65.forwardRef(function YearCalendar2(inProps, ref) {
  ...
  const todayYear = React65.useMemo(() => adapter.getYear(now), [adapter, now]);
  ...
  const [focusedYear, setFocusedYear] = React65.useState(() => selectedYear || adapter.getYear(referenceDate));
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "YearCalendar",
    state: "hasFocus",
    controlled: hasFocus,
...
function useMeridiemMode(date, ampm, onChange, selectionState) {
  const adapter = usePickerAdapter();
  const cleanDate = React67.useMemo(() => !adapter.isValid(date) ? null : date, [adapter, date]);
  const meridiemMode = getMeridiem(cleanDate, adapter);
  const handleMeridiemChange = React67.useCallback((mode) => {
...
var PickersCalendarHeader = React68.forwardRef(function PickersCalendarHeader2(inProps, ref) {
  const translations = usePickerTranslations();
  const adapter = usePickerAdapter();
  const props = useThemeProps({
    props: inProps,
...
var DateCalendar = React69.forwardRef(function DateCalendar2(inProps, ref) {
  const adapter = usePickerAdapter();
  const {
    ownerState
  } = usePickerPrivateContext();
  ...
  const prevOpenViewRef = React69.useRef(view);
  React69.useEffect(() => {
  ...
  const selectedDays = React69.useMemo(() => [value], [value]);
...
// node_modules/@mui/x-date-pickers/esm/DesktopDatePicker/DesktopDatePicker.js
var DesktopDatePicker = React70.forwardRef(function DesktopDatePicker2(inProps, ref) {
  var _a;
  const adapter = usePickerAdapter();
...
// node_modules/@mui/x-date-pickers/esm/MobileDatePicker/MobileDatePicker.js
var MobileDatePicker = React72.forwardRef(function MobileDatePicker2(inProps, ref) {
  var _a;
  const adapter = usePickerAdapter();
...
//# sourceMappingURL=chunk-Y22LOF4I.js.map
